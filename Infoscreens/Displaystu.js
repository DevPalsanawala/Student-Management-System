        ...
        <View style={{ backgroundColor: Color.primary, flex: 1, }}>
            ...
            <View style={styles.main}>
                <View style={{ alignItems: "flex-end", justifyContent: "center" }}>
                    <TouchableOpacity onPress={() => navigation.navigate('AddStudata')}>
                ...
                <ScrollView >
                    ...
                    {
                        Datastu.length ?
                            Datastu.map((items, index) => <Card style={styles.cardview} key={index}>
                                <Card.Content>
                ...
                <Modal visible={show} transparent={true}>
                    <Updatestudata setshow={setshow} select={select} getapidata={getapidata} />
                </Modal>
            </View>
